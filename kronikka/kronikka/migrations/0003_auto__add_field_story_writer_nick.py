...
class Migration(SchemaMigration):
    ...
    models = {
        u'kronikka.story': {
            ...
            'writer_nick': ('django.db.models.fields.CharField', [], {'default': "'Haamukirjoittaja'", 'max_length': '20'})
        },
        u'kronikka.student': {
            'Meta': {'object_name': 'Student'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'thumbnail': ('django.db.models.fields.files.ImageField', [], {'default': "'thumbnails/nic_cage.jpg'", 'max_length': '100'}),
